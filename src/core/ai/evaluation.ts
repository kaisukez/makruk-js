import { Color, PIECE_POWER, SquareIndex as SI } from "config"
import { forEachPiece } from "core/board/pieces"
import { generateMovesForOneSquare } from "core/moves/generation"
import { isCheckmate, isDraw } from "core/rules/status"
