...
import {
    ...
    stepCountdown,
    isCountdownExpired,
    countPiecesFromBitboard,
} from "bitboard/rules/countdown"

describe("countdown", () => {
    describe("countPiecesFromBitboard", () => {
        ...
        test("should count minimal position", () => {
            const { state } = importFenBitboard("4k3/8/8/8/8/8/8/4K3 w 1")
            const pieceCount = countPiecesFromBitboard(state)
    ...
    describe("calculatePiecePowerCountdown", () => {
        test("should return null when active player has more than just Khun", () => {
            const { state } = importFenBitboard("4k3/8/8/8/8/8/8/4KR2 w 1")
            expect(calculatePiecePowerCountdown(state, Color.WHITE)).toBeNull()
        })

        test("should return null when there are Bia on board", () => {
            const { state } = importFenBitboard("4k3/8/8/8/8/8/3B4/4K3 w 1")
            expect(calculatePiecePowerCountdown(state, Color.WHITE)).toBeNull()
        })

        test("should calculate countdown for 1 Rua", () => {
            const { state } = importFenBitboard("4k3/8/8/8/8/8/8/4K2r w 1")
        ...
        test("should calculate countdown for 2 Rua", () => {
            const { state } = importFenBitboard("4k3/8/8/8/8/8/8/r3K2r w 1")
            const result = calculatePiecePowerCountdown(state, Color.WHITE)
            expect(result).toEqual({
                countFrom: 1,
                countTo: 8,
        ...
        test("should calculate countdown for 1 Thon", () => {
            const { state } = importFenBitboard("4k3/8/8/8/8/8/8/4K2t w 1")
            const result = calculatePiecePowerCountdown(state, Color.WHITE)
            expect(result).toEqual({
                countFrom: 1,
                countTo: 44,
        ...
        test("should calculate countdown for 2 Thon", () => {
            const { state } = importFenBitboard("4k3/8/8/8/8/8/8/t3K2t w 1")
            const result = calculatePiecePowerCountdown(state, Color.WHITE)
            expect(result).toEqual({
                countFrom: 1,
                countTo: 22,
        ...
        test("should calculate countdown for 1 Ma", () => {
            const { state } = importFenBitboard("4k3/8/8/8/8/8/8/4K2m w 1")
            const result = calculatePiecePowerCountdown(state, Color.WHITE)
            expect(result).toEqual({
                countFrom: 1,
                countTo: 64,
        ...
        test("should calculate countdown for 2 Ma", () => {
            const { state } = importFenBitboard("4k3/8/8/8/8/8/8/m3K2m w 1")
            const result = calculatePiecePowerCountdown(state, Color.WHITE)
            expect(result).toEqual({
                countFrom: 1,
                countTo: 32,
        ...
        test("should calculate countdown for other pieces (Met)", () => {
            const { state } = importFenBitboard("4k3/8/8/8/8/8/8/4K2e w 1")
            const result = calculatePiecePowerCountdown(state, Color.WHITE)
            expect(result).toEqual({
                countFrom: 1,
                countTo: 64,
    ...
    describe("calculateBoardPowerCountdown", () => {
        ...
        test("should return null when there are Bia on board", () => {
            const { state } = importFenBitboard("4k3/8/8/8/8/8/3B4/4KR2 w 1")
            expect(calculateBoardPowerCountdown(state, Color.WHITE)).toBeNull()
        })
        ...
        test("should count all pieces on board", () => {
            const { state } = importFenBitboard("4k3/8/8/8/8/8/8/rmt1KRM1 w 1")
            const result = calculateBoardPowerCountdown(state, Color.WHITE)
            expect(result).toEqual({
                countFrom: 7,
                countTo: 64,
    ...
    describe("calculateCountdown", () => {
        ...
        test("should set correct countColor for black", () => {
            const { state } = importFenBitboard("4k2R/8/8/8/8/8/8/4K3 b 1")
    ...
    describe("stepCountdown", () => {
        ...
        test("should transition from board power to piece power countdown", () => {
            ...
            const { state: state1 } = importFenBitboard("4k3/8/8/8/8/8/8/4KR2 w 1")
            ...
            const { state: state2 } = importFenBitboard("4k3/8/8/8/8/8/8/4K2r w 1")
