...
describe("applyMove", () => {
    test("should apply a pawn move", () => {
        ...
        const newState = applyMove(state, pawnMove!)
    ...
    test("should apply knight moves correctly", () => {
        ...
        const newState = applyMove(state, knightMove!)
    ...
    test("should throw error for invalid move.from", () => {
        ...
        expect(() => applyMove(state, invalidMove)).toThrow("Invalid move.from")
    })
    ...
    test("should throw error for invalid move.to", () => {
        ...
        expect(() => applyMove(state, invalidMove)).toThrow("Invalid move.to")
    })
    ...
    test("should apply black piece moves", () => {
        ...
        const newState = applyMove(state, kingMove)
    ...
    test("should apply black BIA move", () => {
        ...
        if (biaMove) {
            const newState = applyMove(state, biaMove)
    ...
    test("should apply black FLIPPED_BIA move", () => {
        ...
        if (flippedBiaMove) {
            const newState = applyMove(state, flippedBiaMove)
    ...
    test("should apply black MA move", () => {
        ...
        if (maMove) {
            const newState = applyMove(state, maMove)
    ...
    test("should apply black THON move", () => {
        ...
        if (thonMove) {
            const newState = applyMove(state, thonMove)
    ...
    test("should apply black MET move", () => {
        ...
        if (metMove) {
            const newState = applyMove(state, metMove)
    ...
    test("should apply black RUA move", () => {
        ...
        if (ruaMove) {
            const newState = applyMove(state, ruaMove)
    ...
    test("should apply pawn promotion", () => {
        ...
        if (promotionMove) {
            const newState = applyMove(state, promotionMove)
    ...
    test("should handle black FLIPPED_BIA to black RUA conversion", () => {
        ...
        const newState1 = applyMove(state, move1)
        const newState2 = applyMove(newState1, move2)
